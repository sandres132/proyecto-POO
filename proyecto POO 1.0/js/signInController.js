                ...
                <div class="card-body pb-0 mb-0">
                    <form class="form-control py-0">
                        ...
                        <div class="form-row py-1">
                            ...
                            <input type="text" id="longComp" class="form-control" aria-describedby="longCompHelp" oninput="validacion('longComp')" pattern="[a-zA-Z àáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{5,50}" required><small id="longCompHelp" class="text-muted ">Put your company longitude as an example: 41.40338</small>
                        </div>
                        <div class="form-row py-1">
                            <label for="latComp"><b><i class="fa fa-institution"> Company latitude</i></b></label>
                            <input type="text" id="latComp" class="form-control" aria-describedby="latCompHelp" oninput="validacion('latComp')" pattern="[a-zA-Z àáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{5,50}" required><small id="latCompHelp" class="text-muted ">Put your company latitude as an example: 2.17403</small>
                        </div>
                        <div class="form-row py-1">
                            <label for="selectPais"><i class="fa fa-flag-checkered"> Select País</i></label>
...
function cambiar() {
    document.getElementById("selectPais").style.borderColor = "red";
    document.getElementById("selectPais").style.color = "red";
}
